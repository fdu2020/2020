...
HD_PWD='F:/MZ7100/CODE/S01/S01_CH09_CLK_DIV/Divider_Multiple/Miz_sys.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Divider_Multiple_top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Divider_Multiple_top.tcl
