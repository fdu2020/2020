...
// ==============================================================
#ifndef __ImgProcess_Top_mafYi__HH__
#define __ImgProcess_Top_mafYi__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ImgProcess_Top_mafYi) {
    ...
    SC_CTOR(ImgProcess_Top_mafYi):  simcore_mac_4_U ("simcore_mac_4_U") {
