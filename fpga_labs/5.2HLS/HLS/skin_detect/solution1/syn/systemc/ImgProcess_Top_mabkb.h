...
// ==============================================================
#ifndef __ImgProcess_Top_mabkb__HH__
#define __ImgProcess_Top_mabkb__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(ImgProcess_Top_mabkb) {
    ...
    SC_CTOR(ImgProcess_Top_mabkb):  simcore_mac_0_U ("simcore_mac_0_U") {
