...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if ((~((cr_upper_out_full_n == 1'b0) | (cr_lower_out_full_n == 1'b0) | (cb_upper_out_full_n == 1'b0) | (cb_lower_out_full_n == 1'b0) | (real_start == 1'b0) | (y_upper_out_full_n == 1'b0) | (y_lower_out_full_n == 1'b0) | (img_1_cols_V_out_full_n == 1'b0) | (img_1_rows_V_out_full_n == 1'b0) | (cols_out_full_n == 1'b0) | (rows_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((~((cr_upper_out_full_n == 1'b0) | (cr_lower_out_full_n == 1'b0) | (cb_upper_out_full_n == 1'b0) | (cb_lower_out_full_n == 1'b0) | (real_start == 1'b0) | (y_upper_out_full_n == 1'b0) | (y_lower_out_full_n == 1'b0) | (img_1_cols_V_out_full_n == 1'b0) | (img_1_rows_V_out_full_n == 1'b0) | (cols_out_full_n == 1'b0) | (rows_out_full_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
...
always @ (*) begin
    ap_block_state1 = ((cr_upper_out_full_n == 1'b0) | (cr_lower_out_full_n == 1'b0) | (cb_upper_out_full_n == 1'b0) | (cb_lower_out_full_n == 1'b0) | (real_start == 1'b0) | (y_upper_out_full_n == 1'b0) | (y_lower_out_full_n == 1'b0) | (img_1_cols_V_out_full_n == 1'b0) | (img_1_rows_V_out_full_n == 1'b0) | (cols_out_full_n == 1'b0) | (rows_out_full_n == 1'b0) | (ap_done_reg == 1'b1));
end
