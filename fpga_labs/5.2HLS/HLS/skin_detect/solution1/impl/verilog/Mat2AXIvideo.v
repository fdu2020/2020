...
reg   [31:0] t_V_1_reg_300;
reg   [31:0] rows_V_reg_386;
reg    ap_block_state1;
reg   [31:0] cols_V_reg_391;
wire   [32:0] ret_V_fu_315_p2;
reg   [32:0] ret_V_reg_396;
wire   [0:0] exitcond1_i_fu_326_p2;
wire    ap_CS_fsm_state2;
wire   [31:0] i_V_fu_331_p2;
reg   [31:0] i_V_reg_405;
wire   [0:0] exitcond_i_fu_337_p2;
wire    ap_block_state3_pp0_stage0_iter0;
wire    AXI_video_strm_V_id_V1_status;
reg    ap_block_state4_pp0_stage0_iter1;
reg    ap_block_pp0_stage0_11001;
wire   [31:0] j_V_fu_342_p2;
reg    ap_enable_reg_pp0_iter0;
wire   [0:0] axi_last_V_fu_352_p2;
reg   [0:0] axi_last_V_reg_419;
...
reg   [0:0] tmp_user_V_fu_226;
wire   [32:0] lhs_V_cast_i_fu_311_p1;
wire   [32:0] tmp_cast_i_fu_348_p1;
reg   [3:0] ap_NS_fsm;
reg    ap_idle_pp0;
wire    ap_enable_pp0;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((1'b1 == ap_CS_fsm_state2) & (exitcond1_i_fu_326_p2 == 1'd1))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b1 == ap_CS_fsm_pp0_stage0) & (1'b1 == ap_condition_pp0_exit_iter0_state3) & (1'b0 == ap_block_pp0_stage0_subdone))) begin
            ap_enable_reg_pp0_iter0 <= 1'b0;
        end else if (((exitcond1_i_fu_326_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_337_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_i_reg_410 == 1'd0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
        tmp_user_V_fu_226 <= 1'd0;
    end else if ((~((ap_start == 1'b0) | (img_cols_V_empty_n == 1'b0) | (img_rows_V_empty_n == 1'b0) | (ap_done_reg == 1'b1)) & (1'b1 == ap_CS_fsm_state1))) begin
        tmp_user_V_fu_226 <= 1'd1;
    end
end

always @ (posedge ap_clk) begin
    if (((exitcond_i_fu_337_p2 == 1'd0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (1'b0 == ap_block_pp0_stage0_11001))) begin
...
always @ (*) begin
    if (((exitcond_i_reg_410 == 1'd0) & (1'b0 == ap_block_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
...
always @ (*) begin
    if ((exitcond_i_fu_337_p2 == 1'd1)) begin
...
always @ (*) begin
    if (((1'b1 == ap_CS_fsm_state2) & (exitcond1_i_fu_326_p2 == 1'd1))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
always @ (*) begin
    case (ap_CS_fsm)
        ...
        ap_ST_fsm_pp0_stage0 : begin
            if (~((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_i_fu_337_p2 == 1'd1))) begin
                ap_NS_fsm = ap_ST_fsm_pp0_stage0;
            end else if (((ap_enable_reg_pp0_iter0 == 1'b1) & (1'b0 == ap_block_pp0_stage0_subdone) & (exitcond_i_fu_337_p2 == 1'd1))) begin
...
assign AXI_video_strm_V_data_V_din = {{{{{{8'd255}, {img_data_stream_2_V_dout}}}, {img_data_stream_1_V_dout}}}, {img_data_stream_0_V_dout}};
...
always @ (*) begin
    ap_block_pp0_stage0_01001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_i_reg_410 == 1'd0) & (1'b0 == AXI_video_strm_V_id_V1_status)) | ((exitcond_i_reg_410 == 1'd0) & (img_data_stream_2_V_empty_n == 1'b0)) | ((exitcond_i_reg_410 == 1'd0) & (img_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_i_reg_410 == 1'd0) & (img_data_stream_0_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_11001 = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_i_reg_410 == 1'd0) & (1'b0 == AXI_video_strm_V_id_V1_status)) | ((exitcond_i_reg_410 == 1'd0) & (img_data_stream_2_V_empty_n == 1'b0)) | ((exitcond_i_reg_410 == 1'd0) & (img_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_i_reg_410 == 1'd0) & (img_data_stream_0_V_empty_n == 1'b0))));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((ap_enable_reg_pp0_iter1 == 1'b1) & (((exitcond_i_reg_410 == 1'd0) & (1'b0 == AXI_video_strm_V_id_V1_status)) | ((exitcond_i_reg_410 == 1'd0) & (img_data_stream_2_V_empty_n == 1'b0)) | ((exitcond_i_reg_410 == 1'd0) & (img_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_i_reg_410 == 1'd0) & (img_data_stream_0_V_empty_n == 1'b0))));
end
...
always @ (*) begin
    ap_block_state4_pp0_stage0_iter1 = (((exitcond_i_reg_410 == 1'd0) & (1'b0 == AXI_video_strm_V_id_V1_status)) | ((exitcond_i_reg_410 == 1'd0) & (img_data_stream_2_V_empty_n == 1'b0)) | ((exitcond_i_reg_410 == 1'd0) & (img_data_stream_1_V_empty_n == 1'b0)) | ((exitcond_i_reg_410 == 1'd0) & (img_data_stream_0_V_empty_n == 1'b0)));
end

assign ap_enable_pp0 = (ap_idle_pp0 ^ 1'b1);

assign axi_last_V_fu_352_p2 = ((tmp_cast_i_fu_348_p1 == ret_V_reg_396) ? 1'b1 : 1'b0);

assign exitcond1_i_fu_326_p2 = ((t_V_reg_289 == rows_V_reg_386) ? 1'b1 : 1'b0);

assign exitcond_i_fu_337_p2 = ((t_V_1_reg_300 == cols_V_reg_391) ? 1'b1 : 1'b0);

assign i_V_fu_331_p2 = (t_V_reg_289 + 32'd1);

assign j_V_fu_342_p2 = (t_V_1_reg_300 + 32'd1);

assign lhs_V_cast_i_fu_311_p1 = img_cols_V_dout;

assign ret_V_fu_315_p2 = ($signed(lhs_V_cast_i_fu_311_p1) + $signed(33'd8589934591));

assign tmp_cast_i_fu_348_p1 = t_V_1_reg_300;
