...
entity hls_hough_line_p_ocq_ram is 
    generic(
            MEM_TYPE    : string := "block"; 
            DWIDTH     : integer := 32; 
            AWIDTH     : integer := 21; 
            MEM_SIZE    : integer := 1089900
    ); 
    port (
...
architecture rtl of hls_hough_line_p_ocq_ram is 
...
entity hls_hough_line_p_ocq is
    generic (
        DataWidth : INTEGER := 32;
        AddressRange : INTEGER := 1089900;
...
architecture arch of hls_hough_line_p_ocq is
    component hls_hough_line_p_ocq_ram is
        port (
            clk : IN STD_LOGIC;
...
begin
    hls_hough_line_p_ocq_ram_U :  component hls_hough_line_p_ocq_ram
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
