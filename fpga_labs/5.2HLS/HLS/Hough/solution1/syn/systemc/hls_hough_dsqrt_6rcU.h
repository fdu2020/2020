...
// ==============================================================
#ifndef __hls_hough_dsqrt_6rcU__HH__
#define __hls_hough_dsqrt_6rcU__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_hough_dsqrt_6rcU) {
    ...
    SC_CTOR(hls_hough_dsqrt_6rcU):  ACMP_dsqrt_U ("ACMP_dsqrt_U") {
