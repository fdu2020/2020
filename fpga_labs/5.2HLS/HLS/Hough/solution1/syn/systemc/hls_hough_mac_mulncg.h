...
// ==============================================================
#ifndef __hls_hough_mac_mulncg__HH__
#define __hls_hough_mac_mulncg__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_hough_mac_mulncg) {
    ...
    SC_CTOR(hls_hough_mac_mulncg):  simcore_mac_0_U ("simcore_mac_0_U") {
