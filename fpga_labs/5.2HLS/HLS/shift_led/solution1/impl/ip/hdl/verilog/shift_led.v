...
(* CORE_GENERATION_INFO="shift_led,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=1,HLS_INPUT_PART=xcku115-flva1517-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=others,HLS_SYN_CLOCK=1.460875,HLS_SYN_LAT=50000001,HLS_SYN_TPT=none,HLS_SYN_MEM=0,HLS_SYN_DSP=0,HLS_SYN_FF=45,HLS_SYN_LUT=144,HLS_VERSION=2018_3}" *)
...
reg   [7:0] led_i_V_preg;
reg   [7:0] led_i_V_in_sig;
reg    led_i_V_ap_vld_preg;
reg    led_i_V_ap_vld_in_sig;
reg    led_i_V_blk_n;
wire   [25:0] i_V_fu_83_p2;
wire    ap_CS_fsm_state2;
reg   [25:0] p_Val2_s_reg_61;
reg    ap_block_state1;
wire   [0:0] exitcond_fu_77_p2;
reg   [7:0] p_s_fu_44;
wire   [7:0] tmp_led_V_fu_110_p3;
wire   [0:0] tmp_fu_89_p2;
wire   [6:0] tmp_2_fu_106_p1;
wire   [0:0] tmp_1_fu_98_p3;
reg   [1:0] ap_NS_fsm;
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_77_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
        ...
        p_Val2_s_reg_61 <= 26'd0;
    end
end

always @ (posedge ap_clk) begin
    if (((tmp_fu_89_p2 == 1'd1) & (exitcond_fu_77_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state2))) begin
...
assign exitcond_fu_77_p2 = ((p_Val2_s_reg_61 == 26'd50000000) ? 1'b1 : 1'b0);

assign i_V_fu_83_p2 = (p_Val2_s_reg_61 + 26'd1);

assign led_o_V = {{tmp_2_fu_106_p1}, {tmp_1_fu_98_p3}};

assign tmp_1_fu_98_p3 = p_s_fu_44[32'd7];

assign tmp_2_fu_106_p1 = p_s_fu_44[6:0];

assign tmp_fu_89_p2 = ((p_Val2_s_reg_61 == 26'd49999998) ? 1'b1 : 1'b0);

assign tmp_led_V_fu_110_p3 = {{tmp_2_fu_106_p1}, {tmp_1_fu_98_p3}};
