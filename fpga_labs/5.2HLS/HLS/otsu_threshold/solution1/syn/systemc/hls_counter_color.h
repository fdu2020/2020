...
#ifndef _hls_counter_color_HH_
#define _hls_counter_color_HH_
...
#include "start_for_threshoocq.h"
#include "start_for_CvtColopcA.h"
#include "start_for_Mat2AXIqcK.h"

namespace ap_rtl {

struct hls_counter_color : public sc_module {
    ...
    // Module declarations
    hls_counter_color(sc_module_name name);
    SC_HAS_PROCESS(hls_counter_color);
