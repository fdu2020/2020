...
// ==============================================================
#ifndef __hls_counter_colorbkb__HH__
#define __hls_counter_colorbkb__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_counter_colorbkb) {
    ...
    SC_CTOR(hls_counter_colorbkb):  ACMP_smul_uu_U ("ACMP_smul_uu_U") {
