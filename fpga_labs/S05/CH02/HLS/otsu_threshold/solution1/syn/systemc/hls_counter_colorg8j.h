...
// ==============================================================
#ifndef __hls_counter_colorg8j__HH__
#define __hls_counter_colorg8j__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_counter_colorg8j) {
    ...
    SC_CTOR(hls_counter_colorg8j):  ACMP_faddfsub_U ("ACMP_faddfsub_U") {
