...
// ==============================================================
#ifndef __hls_counter_colordEe__HH__
#define __hls_counter_colordEe__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_counter_colordEe) {
    ...
    SC_CTOR(hls_counter_colordEe):  simcore_mac_1_U ("simcore_mac_1_U") {
