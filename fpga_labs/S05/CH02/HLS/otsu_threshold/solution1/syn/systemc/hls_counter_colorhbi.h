...
// ==============================================================
#ifndef __hls_counter_colorhbi__HH__
#define __hls_counter_colorhbi__HH__
#include "ACMP_fmul.h"
#include <systemc>
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_counter_colorhbi) {
    ...
    SC_CTOR(hls_counter_colorhbi):  ACMP_fmul_U ("ACMP_fmul_U") {
        ACMP_fmul_U.clk(clk);
