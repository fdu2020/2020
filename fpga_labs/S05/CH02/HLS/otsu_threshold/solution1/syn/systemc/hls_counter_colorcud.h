...
// ==============================================================
#ifndef __hls_counter_colorcud__HH__
#define __hls_counter_colorcud__HH__
...
template<
    ...
    int din2_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_counter_colorcud) {
    ...
    SC_CTOR(hls_counter_colorcud):  simcore_mac_0_U ("simcore_mac_0_U") {
