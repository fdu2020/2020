...
// ==============================================================
#ifndef __hls_counter_colormb6__HH__
#define __hls_counter_colormb6__HH__
...
template<
    ...
    int din1_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_counter_colormb6) {
    ...
    SC_CTOR(hls_counter_colormb6):  ACMP_fcmp_comb_U ("ACMP_fcmp_comb_U") {
