...
// ==============================================================
#ifndef __hls_counter_colorlbW__HH__
#define __hls_counter_colorlbW__HH__
...
template<
    ...
    int din0_WIDTH,
    int dout_WIDTH>
SC_MODULE(hls_counter_colorlbW) {
    ...
    SC_CTOR(hls_counter_colorlbW):  ACMP_fpext_comb_U ("ACMP_fpext_comb_U") {
