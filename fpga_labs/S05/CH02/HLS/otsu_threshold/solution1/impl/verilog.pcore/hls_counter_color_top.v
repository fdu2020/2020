// ==============================================================
// File generated on Tue Jul 28 16:41:05 +0800 2020
...
wire [32 - 1:0] sig_hls_counter_color_rows;
wire [32 - 1:0] sig_hls_counter_color_cols;
wire sig_hls_counter_color_ap_start;
wire sig_hls_counter_color_ap_ready;
wire sig_hls_counter_color_ap_done;
wire sig_hls_counter_color_ap_idle;

wire sig_hls_counter_color_ap_rst_n;



hls_counter_color hls_counter_color_U(
    .rows(sig_hls_counter_color_rows),
    .cols(sig_hls_counter_color_cols),
    .ap_start(sig_hls_counter_color_ap_start),
    .ap_ready(sig_hls_counter_color_ap_ready),
    .ap_done(sig_hls_counter_color_ap_done),
    .ap_idle(sig_hls_counter_color_ap_idle),
    .ap_rst_n(sig_hls_counter_color_ap_rst_n),
    .ap_clk(aclk),
...
hls_counter_color_CONTROL_BUS_if #(
    .C_ADDR_WIDTH(C_S_AXI_CONTROL_BUS_ADDR_WIDTH),
    .C_DATA_WIDTH(C_S_AXI_CONTROL_BUS_DATA_WIDTH))
hls_counter_color_CONTROL_BUS_if_U(
    .ACLK(aclk),
    .ARESETN(aresetn),
    .I_rows(sig_hls_counter_color_rows),
    .I_cols(sig_hls_counter_color_cols),
    .I_ap_start(sig_hls_counter_color_ap_start),
    .O_ap_ready(sig_hls_counter_color_ap_ready),
    .O_ap_done(sig_hls_counter_color_ap_done),
    .O_ap_idle(sig_hls_counter_color_ap_idle),
...
hls_counter_color_ap_rst_n_if #(
    .RESET_ACTIVE_LOW(RESET_ACTIVE_LOW))
ap_rst_n_if_U(
    .dout(sig_hls_counter_color_ap_rst_n),
    .din(aresetn));
