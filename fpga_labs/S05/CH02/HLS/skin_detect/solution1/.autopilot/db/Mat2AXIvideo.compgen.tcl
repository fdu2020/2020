...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { AXI_video_strm_V_data_V_din { O 32 vector } AXI_video_strm_V_data_V_full_n { I 1 bit } AXI_video_strm_V_data_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { AXI_video_strm_V_keep_V_din { O 4 vector } AXI_video_strm_V_keep_V_full_n { I 1 bit } AXI_video_strm_V_keep_V_write { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { AXI_video_strm_V_strb_V_din { O 4 vector } AXI_video_strm_V_strb_V_full_n { I 1 bit } AXI_video_strm_V_strb_V_write { O 1 bit } } \
} "
}
