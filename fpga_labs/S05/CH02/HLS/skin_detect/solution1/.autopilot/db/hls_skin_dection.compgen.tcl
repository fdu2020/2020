...
set out_width 15
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {6 0 +} m {14 0 +} i2 {15 0 +} p {15 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
...
set out_width 16
set exp i0*i1+i2
set arg_lists {i0 {8 0 +} i1 {9 0 +} m {16 0 +} i2 {15 0 +} p {16 0 +} c_reg {1} rnd {0} acc {0} }
set TrueReset 0
if {${::AESL::PGuard_simmodel_gen}} {
if {[info proc ap_gen_simcore_mac] == "ap_gen_simcore_mac"} {
eval "ap_gen_simcore_mac { \
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_y_lower \
    op interface \
    ports { y_lower_dout { I 32 vector } y_lower_empty_n { I 1 bit } y_lower_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    corename dc_y_upper \
    op interface \
    ports { y_upper_dout { I 32 vector } y_upper_empty_n { I 1 bit } y_upper_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { cb_lower_dout { I 32 vector } cb_lower_empty_n { I 1 bit } cb_lower_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { cb_upper_dout { I 32 vector } cb_upper_empty_n { I 1 bit } cb_upper_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { cr_lower_dout { I 32 vector } cr_lower_empty_n { I 1 bit } cr_lower_read { O 1 bit } } \
} "
}
...
eval "cg_default_interface_gen_dc { \
    ...
    op interface \
    ports { cr_upper_dout { I 32 vector } cr_upper_empty_n { I 1 bit } cr_upper_read { O 1 bit } } \
} "
}
