...
set C_modelArgList {
	...
	{ dst_rows_V int 32 regular {ap_stable 0} }
	{ dst_cols_V int 32 regular {ap_stable 0} }
...
set C_modelArgMapList {[ 
	{ "Name" : "src_data_stream_0_V", "interface" : "fifo", "bitwidth" : 8, "direction" : "READONLY"} , 
 	...
 	{ "Name" : "dst_rows_V", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
 	{ "Name" : "dst_cols_V", "interface" : "wire", "bitwidth" : 32, "direction" : "READONLY"} , 
...
set portList { 
	...
	{ dst_rows_V sc_in sc_lv 32 signal 3 } 
	{ dst_cols_V sc_in sc_lv 32 signal 4 } 
...
set NewPortList {[ 
	{ "name": "ap_clk", "direction": "in", "datatype": "sc_logic", "bitwidth":1, "type": "clock", "bundle":{"name": "ap_clk", "role": "default" }} , 
 	...
 	{ "name": "dst_rows_V", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dst_rows_V", "role": "default" }} , 
 	{ "name": "dst_cols_V", "direction": "in", "datatype": "sc_lv", "bitwidth":32, "type": "signal", "bundle":{"name": "dst_cols_V", "role": "default" }} , 
...
set RtlHierarchyInfo {[
	{"ID" : "0", "Level" : "0", "Path" : "`AUTOTB_DUT_INST", "Parent" : "",
		...
		"Port" : [
			...
			{"Name" : "dst_rows_V", "Type" : "Stable", "Direction" : "I"},
			{"Name" : "dst_cols_V", "Type" : "Stable", "Direction" : "I"},
...
set Spec2ImplPortList { 
	...
	dst_rows_V { ap_stable {  { dst_rows_V in_data 0 32 } } }
	dst_cols_V { ap_stable {  { dst_cols_V in_data 0 32 } } }
