...
architecture behav of hls_sobel is 
    ...
    "hls_sobel,hls_ip_2018_3,{HLS_INPUT_TYPE=cxx,HLS_INPUT_FLOAT=0,HLS_INPUT_FIXED=0,HLS_INPUT_PART=xcku115-flvd1517-2-e,HLS_INPUT_CLOCK=10.000000,HLS_INPUT_ARCH=dataflow,HLS_SYN_CLOCK=7.786125,HLS_SYN_LAT=-1,HLS_SYN_TPT=-1,HLS_SYN_MEM=27,HLS_SYN_DSP=0,HLS_SYN_FF=2406,HLS_SYN_LUT=9446,HLS_VERSION=2018_3}";
    ...
    signal SubS_U0_start_out : STD_LOGIC;
    ...
    signal Scale_U0_start_out : STD_LOGIC;
    ...
    signal start_for_SubS_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_SubS_U0_full_n : STD_LOGIC;
    signal start_for_SubS_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_SubS_U0_empty_n : STD_LOGIC;
    signal start_for_Scale_U0_din : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Scale_U0_full_n : STD_LOGIC;
    signal start_for_Scale_U0_dout : STD_LOGIC_VECTOR (0 downto 0);
    signal start_for_Scale_U0_empty_n : STD_LOGIC;
    ...
    component start_for_SubS_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
    ...
    component start_for_Scale_U0 IS
    port (
        clk : IN STD_LOGIC;
        reset : IN STD_LOGIC;
        if_read_ce : IN STD_LOGIC;
...
begin
    ...
    start_for_SubS_U0_U : component start_for_SubS_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Scale_U0_U : component start_for_Scale_U0
    port map (
        clk => ap_clk,
        reset => ap_rst_n_inv,
        if_read_ce => ap_const_logic_1,
    ...
    start_for_Scale_U0_din <= (0=>ap_const_logic_1, others=>'-');
    start_for_Sobel_U0_din <= (0=>ap_const_logic_1, others=>'-');
    start_for_SubS_U0_din <= (0=>ap_const_logic_1, others=>'-');
end behav;
