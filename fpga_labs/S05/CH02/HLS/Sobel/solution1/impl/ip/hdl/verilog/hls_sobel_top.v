// ==============================================================
// File generated on Sat Jul 25 15:54:59 +0800 2020
...
wire [32 - 1:0] sig_hls_sobel_rows;
wire [32 - 1:0] sig_hls_sobel_cols;
wire sig_hls_sobel_ap_start;
wire sig_hls_sobel_ap_ready;
wire sig_hls_sobel_ap_done;
wire sig_hls_sobel_ap_idle;

wire sig_hls_sobel_ap_rst_n;



hls_sobel hls_sobel_U(
    .rows(sig_hls_sobel_rows),
    .cols(sig_hls_sobel_cols),
    .ap_start(sig_hls_sobel_ap_start),
    .ap_ready(sig_hls_sobel_ap_ready),
    .ap_done(sig_hls_sobel_ap_done),
    .ap_idle(sig_hls_sobel_ap_idle),
    .ap_rst_n(sig_hls_sobel_ap_rst_n),
    .ap_clk(aclk),
...
hls_sobel_CONTROL_BUS_if #(
    .C_ADDR_WIDTH(C_S_AXI_CONTROL_BUS_ADDR_WIDTH),
    .C_DATA_WIDTH(C_S_AXI_CONTROL_BUS_DATA_WIDTH))
hls_sobel_CONTROL_BUS_if_U(
    .ACLK(aclk),
    .ARESETN(aresetn),
    .I_rows(sig_hls_sobel_rows),
    .I_cols(sig_hls_sobel_cols),
    .I_ap_start(sig_hls_sobel_ap_start),
    .O_ap_ready(sig_hls_sobel_ap_ready),
    .O_ap_done(sig_hls_sobel_ap_done),
    .O_ap_idle(sig_hls_sobel_ap_idle),
...
hls_sobel_ap_rst_n_if #(
    .RESET_ACTIVE_LOW(RESET_ACTIVE_LOW))
ap_rst_n_if_U(
    .dout(sig_hls_sobel_ap_rst_n),
    .din(aresetn));
