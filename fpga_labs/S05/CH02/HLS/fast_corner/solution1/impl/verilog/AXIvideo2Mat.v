...
wire   [7:0] tmp_70_fu_398_p1;
reg   [7:0] tmp_70_reg_479;
reg   [7:0] tmp_28_reg_484;
reg   [7:0] tmp_29_reg_489;
reg    ap_block_state8;
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if ((ap_continue == 1'b1)) begin
            ap_done_reg <= 1'b0;
        end else if (((exitcond2_fu_367_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
            ap_done_reg <= 1'b1;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (ap_rst == 1'b1) begin
        ...
        if (((1'b0 == ap_block_pp1_stage0_subdone) & (1'b1 == ap_condition_pp1_exit_iter0_state5) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
            ap_enable_reg_pp1_iter0 <= 1'b0;
        end else if (((exitcond2_fu_367_p2 == 1'd0) & (1'b1 == ap_CS_fsm_state4))) begin
...
always @ (posedge ap_clk) begin
    if (((exitcond_fu_378_p2 == 1'd0) & (1'b0 == ap_block_pp1_stage0_11001) & (1'b1 == ap_CS_fsm_pp1_stage0))) begin
        tmp_28_reg_484 <= {{ap_phi_mux_p_Val2_s_phi_fu_306_p4[15:8]}};
        tmp_29_reg_489 <= {{ap_phi_mux_p_Val2_s_phi_fu_306_p4[23:16]}};
...
always @ (*) begin
    if (((exitcond2_fu_367_p2 == 1'd1) & (1'b1 == ap_CS_fsm_state4))) begin
        ap_done = 1'b1;
    end else begin
        ap_done = ap_done_reg;
    end
...
assign exitcond2_fu_367_p2 = ((t_V_reg_233 == img_rows_V) ? 1'b1 : 1'b0);

assign exitcond_fu_378_p2 = ((t_V_6_reg_266 == img_cols_V) ? 1'b1 : 1'b0);

assign i_V_fu_372_p2 = (t_V_reg_233 + 32'd1);

assign img_data_stream_0_V_din = tmp_70_reg_479;

assign img_data_stream_1_V_din = tmp_28_reg_484;

assign img_data_stream_2_V_din = tmp_29_reg_489;

assign j_V_fu_383_p2 = (t_V_6_reg_266 + 32'd1);

assign start_out = real_start;

assign tmp_70_fu_398_p1 = ap_phi_mux_p_Val2_s_phi_fu_306_p4[7:0];
